...
│   └── renders/   # Auto-generated preview PNGs (from scadm export-png)
...
- **`parts/renders/`** — Auto-generated preview PNGs from `scadm export-png`. These are the only image files tracked in this repo.
