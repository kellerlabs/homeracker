...
│   └── renders/   # Auto-generated preview PNGs (from export-png.sh)
...
- **`parts/renders/`** — Auto-generated preview PNGs from `cmd/export/export-png.sh`. These are the only image files tracked in this repo.
