...
Each file below carries `paths:` frontmatter and loads automatically when you touch a matching file.

- Documentation: stick to the house-style skill
- OpenSCAD: [openscad.md](.claude/rules/openscad.md)
